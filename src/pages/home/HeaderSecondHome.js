...
class HeaderSecondHome extends Component {
  render() {
    return (
      <>
        <section
          ...
          style={{
            background:
              'url("https://images.pexels.com/photos/380769/pexels-photo-380769.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940") center center',
          }}
        >
